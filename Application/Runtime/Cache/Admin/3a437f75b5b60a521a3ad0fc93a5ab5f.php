...
<div id="page-wrapper">
    ...
    <div class="container-fluid" >
        ...
        <!-- /.row -->
        <div >
            <button url="/NEWSComplete/admin.php?c=position&a=add" id="button-add" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加 </button>
        </div>
...
<script>
    var SCOPE = {
        'edit_url' : '/'+projectRoot+'/admin.php?c=position&a=edit',
        'set_status_url' : '/'+projectRoot+'/admin.php?c=position&a=setStatus',
        'add_url' : '/'+projectRoot+'/admin.php?c=position&a=add',
    }
    $(".singcms-table #sing-add-position-content").on('click',function(){
        var id = $(this).attr('attr-id');
        window.location.href='/'+projectRoot+'/admin.php?c=positioncontent&a=index&position_id='+id;
    });
</script>
