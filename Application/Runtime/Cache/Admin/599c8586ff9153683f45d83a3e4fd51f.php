	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li>
						<i class="fa fa-dashboard"></i>  <a href="/NEWSComplete/admin.php?c=position">推荐位管理</a>
					</li>
					<li class="active">
...
<script>
	var SCOPE = {
		'save_url' : '/'+projectRoot+'/admin.php?c=position&a=add',
		'jump_url' : '/'+projectRoot+'/admin.php?c=position'
	};
