    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/NEWSComplete/admin.php?c=admin">用户管理</a>
                    </li>
                    <li class="active">
...
<script>
    var SCOPE = {
        'add_url' : '/NEWSComplete/admin.php?c=admin&a=add',
        'edit_url' : '/NEWSComplete/admin.php?c=admin&a=edit',
        'set_status_url' : '/NEWSComplete/admin.php?c=admin&a=setStatus',
        'index_url' : '/',
