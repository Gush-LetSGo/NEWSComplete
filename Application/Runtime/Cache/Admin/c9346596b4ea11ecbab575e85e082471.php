...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <script src="/NEWSComplete/Public/js/kindeditor/kindeditor-all.js"></script>
  <div id="page-wrapper">
...
<script>
  var SCOPE = {
    'save_url' : '/'+projectRoot+'/admin.php?c=content&a=add',
    'jump_url' : '/'+projectRoot+'/admin.php?c=content',
...
<script>
  ...
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/'+projectRoot+'/admin.php?c=image&a=kindupload',
