    ...
    <div class="container-fluid" >
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/NEWSComplete/admin.php?c=menu">菜单管理</a>
                    </li>
                    <li class="active">
...
<script>
    ...
    var SCOPE = {
        'add_url' : '/'+projectRoot+'/admin.php?c=menu&a=add',
        'edit_url' : '/'+projectRoot+'/admin.php?c=menu&a=edit',
        'set_status_url' : '/'+projectRoot+'/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/'+projectRoot+'/admin.php?c=menu&a=listorder',
